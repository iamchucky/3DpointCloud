...
{
	public class OOIrenderer : IRender
	{
		Color color;
		string name;
		PointF location;
		...
		public event EventHandler<OOICommandEventArgs> SendOOIsToRenderer;

		public OOIrenderer(string type, PointF location, string name)
		{
		...
		public OOIrenderer(string type, PointF location, string name, Color color)
		{
			this.color = color;
			this.type = type;
			this.location = location;
		...
		public OOIrenderer(string type, PointF location, string name, Color color, double angle)
		{
			this.color = color;
			this.type = type;
			this.location = location;
		...
		public OOIrenderer(string type, PointF location, string name, Color color, double angle, double arrowlength)
		{
			this.color = color;
			this.type = type;
			this.location = location;
		...
		public OOIrenderer(string type, PointF location, string name, Color color, List<PointF> polygonPoints)
		{
			this.color = color;
			this.type = type;
			this.location = location;
		...
		public void Draw(Renderer r)
		{
			...
			else if (type.Equals("important"))
			{
				...
				GLUtility.DrawCircle(new GLPen(color, 2f), new Vector2(location.X, location.Y - .12), .01f);


				GLUtility.DrawDiamond(new GLPen(color, 3f), new Vector2((double)location.X, (double)location.Y), .5f);
			}
	...
	public class OOICommandEventArgs : EventArgs
	{
		List<OOIrenderer> ooi;
		public List<OOIrenderer> OOIs
		{
			get { return ooi; }
		}
		public OOICommandEventArgs(List<OOIrenderer> Object)
		{
			ooi = Object;
		}
	}
