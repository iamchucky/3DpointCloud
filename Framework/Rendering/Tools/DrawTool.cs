...
namespace Magic.Rendering
{
    ...
    /// </summary>
    public class DrawTool : IRenderToolWithResult<DrawToolCompletedEventArgs>
    {
        ...
        /// </summary>
		public event EventHandler<DrawToolCompletedEventArgs> ToolCompleted;
		...
		public void ManualFinish()
		{
			...
			{
				ToolCompleted(this, new DrawToolCompletedEventArgs(pixelList, TargetFolder, UserName, gestureName, pointList, pixelWidth, pixelHeight));			
				countStrokes = 0;
				isDrawing = false;
    ...
    /// </summary>
    public class DrawToolCompletedEventArgs : EventArgs
    {
		...
		public DrawToolCompletedEventArgs(List<Vector4> lp, string TargetFileName, string UserName, string gestureName,List<PointF> pointList,int pixelWidth,int pixelHeight)
        {
			pixelList = lp;
