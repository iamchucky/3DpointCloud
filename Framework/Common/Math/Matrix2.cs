...
namespace Magic.Common.Mapack {
	...
	public struct Matrix2 {
		...
		public void SymmetricEigenDecomposition(out double[] eigenvalues, out Vector2[] eigenvectors){
			double t = Math.Sqrt(4*d12*d12 + (d11-d22)*(d11-d22));
			double lamda1 = (d11+d22+t)/2;
			double lamda2 = (d11+d22-t)/2;

			Vector2 v1 = new Vector2(1, (d22-d11+t)/(2*d12));
			Vector2 v2 = new Vector2(1, (d22-d11-t)/(2*d12));

			eigenvalues = new double[] { lamda1, lamda2 };
			eigenvectors = new Vector2[] { v1.Normalize(), v2.Normalize() };
		}
		...
		public static Vector2 operator *(Vector2 l, Matrix2 r) {
			return new Vector2(
				r.d11*l.X + r.d21*l.Y,
				r.d12*l.X + r.d22*l.Y);
		}
