...
class Person_PhoneNumber : public ::google::protobuf::Message {
 public:
  ...
  inline ::Magic::Proto::Person_PhoneType type() const;
  inline void set_type(::Magic::Proto::Person_PhoneType value);
...
class Person : public ::google::protobuf::Message {
 public:
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::Magic::Proto::Person_PhoneNumber >& phone() const;
  inline ::google::protobuf::RepeatedPtrField< ::Magic::Proto::Person_PhoneNumber >* mutable_phone();
  inline const ::Magic::Proto::Person_PhoneNumber& phone(int index) const;
  inline ::Magic::Proto::Person_PhoneNumber* mutable_phone(int index);
  inline ::Magic::Proto::Person_PhoneNumber* add_phone();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::Magic::Proto::Person_PhoneNumber > phone_;
  friend void  protobuf_AddDesc_example_2eproto();
  friend void protobuf_AssignDesc_example_2eproto();
  friend void protobuf_ShutdownFile_example_2eproto();
...
inline ::Magic::Proto::Person_PhoneType Person_PhoneNumber::type() const {
  return static_cast< ::Magic::Proto::Person_PhoneType >(type_);
}
inline void Person_PhoneNumber::set_type(::Magic::Proto::Person_PhoneType value) {
  GOOGLE_DCHECK(::Magic::Proto::Person_PhoneType_IsValid(value));
  _set_bit(1);
  type_ = value;
}
...
inline const ::google::protobuf::RepeatedPtrField< ::Magic::Proto::Person_PhoneNumber >&
Person::phone() const {
  return phone_;
}
inline ::google::protobuf::RepeatedPtrField< ::Magic::Proto::Person_PhoneNumber >*
Person::mutable_phone() {
  return &phone_;
}
inline const ::Magic::Proto::Person_PhoneNumber& Person::phone(int index) const {
  return phone_.Get(index);
}
inline ::Magic::Proto::Person_PhoneNumber* Person::mutable_phone(int index) {
  return phone_.Mutable(index);
}
inline ::Magic::Proto::Person_PhoneNumber* Person::add_phone() {
  return phone_.Add();
}
